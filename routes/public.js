...
async function generateTicketNumber() {
  ...
  const lastTicket = await getLastTicketForYear(year);
...
router.post('/api/suivi', async (req, res) => {
  ...
  const incident = await getIncidentByEmailAndTicket(email.trim(), ticket_number.trim());

...
class FileSessionStore extends session.Store {
  constructor(options = {}) {
    super();
    const defaultSessionPath = process.env.SESSION_FILE_PATH || path.join(process.env.RENDER ? '/tmp' : path.join(__dirname, '../data'), 'sessions.json');
    this.filePath = options.filePath || defaultSessionPath;
